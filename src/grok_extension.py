"""Grok-Extension fuer HeyLou [CRUX-MK].

Welle-39 LLM Sub-Funktion. Routet Grok-functionCalls -> HeyLou-Backends.
...
class GrokExtension:
    ...
    Sandbox-Default per ENV-Var DF_HEYLOU_GROK_EXT_ENABLED.
    """

    EXTENSION_ID = "df-heylou-grok-extension"
    PROVIDER = "grok"
    REAL_ENV_VAR = "DF_HEYLOU_GROK_EXT_ENABLED"
